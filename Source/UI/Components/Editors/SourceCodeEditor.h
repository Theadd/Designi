...
#ifndef __SOURCECODEEDITOR_H_9BA56DB5__
#define __SOURCECODEEDITOR_H_9BA56DB5__


#include "../../../Core/Project.h"
#include "../Basics/DocumentEditorComponent.h"
#include "../../Misc/FileHelpers.h"
...
public:
    ...
    struct Type  : public OpenDocumentManager::DocumentType
    {
        ...
        {
            if (file.hasFileExtension ("cpp;mm;m;c;cc;cxx;h;hpp;hxx;hh;inl")
...
public:
	...
	// TOFIX */
	static String getSearchString()                 { return String::empty; }
    static void setSearchString (const String& /*s*/)   { }
    static bool isCaseSensitiveSearch()             { return false; }
    static void setCaseSensitiveSearch (bool /*b*/)     { }
...
#endif  // __SOURCECODEEDITOR_H_9BA56DB5__
